...
SECRET_KEY = 'django-insecure-&t@b7hm8^m+u*8sk0wddv!g@h5sn@b9(d!cux94l*0lvqqjg-1'
...
'''
DEBUG = True
# 아이피를 설정. 개발용인 경우 아래와 같이 로컬호스트로 설정한다.
...
저장하도록 규정되어있다. 개발자가 임의로 images 와 같은 폴더를 생성하더라도 접근할 수 없다.
'''
STATIC_URL = 'static/'
