...
class boardWriteForm(forms.Form):
    ...
    user_name = forms.CharField(label='작성자', max_length=10)
    user_pw = forms.CharField(label='패스워드', min_length=4, max_length=12, widget=forms.PasswordInput())
    ...
    addfile = forms.FileField(label="첨부파일", required=False)